...
Of course I'm happy about feedback and suggestions for improvement. In the footer are my contact details. The source code for the project can be found [here](https://github.com/openscript/r.obin.ch). Let's see what comes out of it. Have a good start into the new year and see you soon.
