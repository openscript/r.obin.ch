...
[React Router](https://reactrouter.com/) ist eines der meist verbreiteten Werkzeuge, um clientseitiges Routing in React zu realisieren. In der kommenden Version 6 werden sich einige Dinge verändern, wie die Migrationsanleitung offenbart.
...
Die Migration war nicht schwierig. Vor allem die Anleitung zur Migration gibt einen schnellen Überblick zu den Änderungen.
